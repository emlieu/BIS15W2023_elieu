...
```{r, message = FALSE}
spider_list <- lapply(files, read_csv) #it will make a list by applying the read_csv function to the object files
```
...
anti_exampleDF #shows you what you are losing when you join
```
