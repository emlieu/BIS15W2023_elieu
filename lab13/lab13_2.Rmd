...
lat <- c(34.67, 41.80)
long <- c(-124.1, -115.5)
bbox <- make_bbox(long, lat, f = 0.05) #f makes sure the points aren't at the very edge of the map/ get cut off
```
...
```{r}
map2 <- get_map(grizzly_bbox, maptype = "terrain", source = "stamen")
```
