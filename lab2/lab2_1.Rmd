...
this means there is missing data in my code chunk and NA is used as a placeholder. This means we can remove NAs from calculations without actually having to find them. 
